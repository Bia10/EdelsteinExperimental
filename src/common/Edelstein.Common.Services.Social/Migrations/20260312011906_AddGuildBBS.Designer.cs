...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edelstein.Common.Services.Social.Entities.GuildBBSCommentEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("guild_bbs_comments", (string)null);
                });

            modelBuilder.Entity("Edelstein.Common.Services.Social.Entities.GuildBBSPostEntity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("guild_bbs_posts", (string)null);
                });
            ...
            modelBuilder.Entity("Edelstein.Common.Services.Social.Entities.GuildBBSCommentEntity", b =>
                {
                    b.HasOne("Edelstein.Common.Services.Social.Entities.GuildBBSPostEntity", "Post")
                        .WithMany("Comments")

...
public class FieldOnPacketPartyInviteRejectResultPlug
    : IPipelinePlug<FieldOnPacketPartyInviteRejectResult>
{
    public async Task Handle(IPipelineContext ctx, FieldOnPacketPartyInviteRejectResult message)
    {
        var response = await message.User.StageUser.Context.Services.Party.InviteReject(
            new PartyInviteRejectRequest(

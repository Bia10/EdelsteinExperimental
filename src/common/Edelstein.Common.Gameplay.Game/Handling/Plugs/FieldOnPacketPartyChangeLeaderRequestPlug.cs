...
public class FieldOnPacketPartyChangeLeaderRequestPlug
    : IPipelinePlug<FieldOnPacketPartyChangeLeaderRequest>
{
    public async Task Handle(IPipelineContext ctx, FieldOnPacketPartyChangeLeaderRequest message)
    {
        ...
        var response = await message.User.StageUser.Context.Services.Party.ChangeBoss(

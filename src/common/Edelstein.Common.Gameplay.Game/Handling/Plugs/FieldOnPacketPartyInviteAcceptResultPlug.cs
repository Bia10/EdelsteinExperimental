...
public class FieldOnPacketPartyInviteAcceptResultPlug
    : IPipelinePlug<FieldOnPacketPartyInviteAcceptResult>
{
    public async Task Handle(IPipelineContext ctx, FieldOnPacketPartyInviteAcceptResult message)
    {
        var response = await message.User.StageUser.Context.Services.Party.InviteAccept(
            new PartyInviteAcceptRequest(

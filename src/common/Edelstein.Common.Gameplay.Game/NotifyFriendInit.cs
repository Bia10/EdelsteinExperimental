...
public class NotifyFriendInit : IPipelinePlug<StageStart>
{
    ...
    public NotifyFriendInit(
        IMessageBus messaging,
        IPipeline<NotifyFriendInvited> notifyFriendInvited,
        IPipeline<NotifyFriendUpdateChannel> notifyFriendUpdateChannel,
        IPipeline<NotifyFriendUpdateList> notifyFriendUpdateList
    )
    {
    ...
    {
        await _messaging.SubscribeAsync<NotifyFriendInvited>(e => _notifyFriendInvited.Process(e));
        await _messaging.SubscribeAsync<NotifyFriendUpdateChannel>(e =>
            _notifyFriendUpdateChannel.Process(e)
        );
        await _messaging.SubscribeAsync<NotifyFriendUpdateList>(e =>
            _notifyFriendUpdateList.Process(e)
        );
    }
}

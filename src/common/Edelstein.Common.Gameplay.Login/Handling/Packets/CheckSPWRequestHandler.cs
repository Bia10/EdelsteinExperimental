...
public class CheckSPWRequestHandler
    : AbstractPipedPacketHandler<ILoginStageUser, UserOnPacketCheckSPWRequest>
{
    public CheckSPWRequestHandler(IPipeline<UserOnPacketCheckSPWRequest> pipeline)
        : base(pipeline) { }
    ...
    public override UserOnPacketCheckSPWRequest Serialize(
        ILoginStageUser user,
        IPacketReader reader
    ) => new(user, reader.ReadString(), reader.ReadInt(), reader.ReadString(), reader.ReadString());
}

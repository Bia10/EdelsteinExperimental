...
public class UserTransferFieldRequestHandler
    : AbstractPipedPacketHandler<ITradeStageUser, TradeOnPacketUserTransferFieldRequest>
{
    public UserTransferFieldRequestHandler(
        IPipeline<TradeOnPacketUserTransferFieldRequest> pipeline
    )
        : base(pipeline) { }
    ...
    public override TradeOnPacketUserTransferFieldRequest? Serialize(

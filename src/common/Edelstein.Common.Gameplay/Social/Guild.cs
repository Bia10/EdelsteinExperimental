...
{
    /// <summary>Immutable read-only guild snapshot constructed from a gRPC contract.</summary>
    public class Guild : IGuild
    {
        ...
        public Guild(GuildContract contract)
        {
            ...
            Members = contract.Members
                .Select<GuildMemberContract, IGuildMember>(m => new GuildMember(m))
                .ToList();
            ...
            AllianceID = contract.AllianceId;
        }
    }
}
